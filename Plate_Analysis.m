...
edge_distanceR1 = zeros(1, 25);
edge_distanceR2 = zeros(1, 25);
edge_distanceR3 = zeros(1, 25);
...
for i = 2:25
    ...
    edge_distanceR1e(i) = xgrid1(sec_deriv_R1e == max(sec_deriv_R1e));
    sec_deriv_R1n = gradient(gradient(plateR1_n(1, :, i)));
    edge_distanceR1n(i) = xgrid1(sec_deriv_R1n == max(sec_deriv_R1n));
    sec_deriv_R1w = gradient(gradient(plateR1_w(1, :, i)));
    edge_distanceR1w(i) = xgrid1(sec_deriv_R1w == max(sec_deriv_R1w));
    sec_deriv_R1s = gradient(gradient(plateR1_s(1, :, i)));
    edge_distanceR1s(i) = xgrid1(sec_deriv_R1s == max(sec_deriv_R1s));
    
%     sec_deriv_R2e = gradient(gradient(plateR2_e(1, :, i)));
%     edge_distanceR2e(i) = xgrid2(sec_deriv_R2e == max(sec_deriv_R2e));
%     sec_deriv_R2n = gradient(gradient(plateR2_n(1, :, i)));
%     edge_distanceR2n(i) = xgrid2(sec_deriv_R2n == max(sec_deriv_R2n));
%     sec_deriv_R2w = gradient(gradient(plateR2_w(1, :, i)));
%     edge_distanceR2w(i) = xgrid2(sec_deriv_R2w == max(sec_deriv_R2w));
%     sec_deriv_R2s = gradient(gradient(plateR2_s(1, :, i)));
%     edge_distanceR2s(i) = xgrid2(sec_deriv_R2s == max(sec_deriv_R2s));
%         
%     sec_deriv_R3e = gradient(gradient(plateR3_e(1, :, i)));
%     edge_distanceR3e(i) = xgrid3(sec_deriv_R3e == max(sec_deriv_R3e));
%     sec_deriv_R3n = gradient(gradient(plateR3_n(1, :, i)));
%     edge_distanceR3n(i) = xgrid3(sec_deriv_R3n == max(sec_deriv_R3n));
%     sec_deriv_R3w = gradient(gradient(plateR3_w(1, :, i)));
%     edge_distanceR3w(i) = xgrid3(sec_deriv_R3w == max(sec_deriv_R3w));
%     sec_deriv_R3s = gradient(gradient(plateR3_s(1, :, i)));
%     edge_distanceR3s(i) = xgrid3(sec_deriv_R3s == max(sec_deriv_R3s));
end

edge_distanceR1 = (edge_distanceR1e+edge_distanceR1n+edge_distanceR1w+edge_distanceR1s)/4;
%edge_distanceR2 = (edge_distanceR2e+edge_distanceR2w+edge_distanceR2s)/4;
%edge_distanceR3 = (edge_distanceR3n+edge_distanceR3w+edge_distanceR3s)/4;